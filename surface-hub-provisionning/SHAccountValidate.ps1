...
if ($fSfbIsOnline)
{
    ...
    {
        CleanupAndFail "To verify Skype for Business in online tenants you need the Lync Online Connector module from http://www.microsoft.com/en-us/download/details.aspx?id=39366"
    }
}
else
{
